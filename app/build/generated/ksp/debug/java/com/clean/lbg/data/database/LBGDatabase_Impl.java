package com.clean.lbg.data.database;
...
import com.clean.lbg.data.database.dao.FavouriteDao;
import com.clean.lbg.data.database.dao.FavouriteDao_Impl;
    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        if (!_infoFavouriteDetails.equals(_existingFavouriteDetails)) {
          return new RoomOpenHelper.ValidationResult(false, "favourite_details(com.clean.lbg.data.database.entities.FavImageEntity).\n"
