...
import com.clean.lbg.modelsMocks.toResponseFavCats
import com.clean.lbg.presentation.contracts.CatContract
import com.clean.lbg.presentation.ui.components.EmptyView
import com.clean.lbg.presentation.ui.features.cats.view.CatScreen
import com.clean.lbg.presentation.ui.features.cats.view.CatsList
import com.clean.lbg.presentation.ui.features.cats.view.ItemThumbnail
import com.clean.lbg.presentation.ui.features.cats.view.LoadingBar
import com.clean.lbg.presentation.ui.features.cats.view.UserView
import com.clean.lbg.utils.TestTags
import com.clean.lbg.utils.TestTags.PROGRESS_BAR
...
class CatsScreenKtTest {
    ...
    fun testUserView_IfLoadingIsTrue() {
        ...
        composeTestRule.setContent {
            if (state != null) {
                UserView(state = state, isFavCatsCall = false, onNavigationRequested = { _, _ -> })
            }
        }
